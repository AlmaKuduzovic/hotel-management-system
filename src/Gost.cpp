...
void Menu::addGost (){
    ...
    //napravite ogranicenja za unos kombinacije slova i brojeva,npr "Alma1",mozete koristiti string:npos
    cout<<"Unesite prezime: "<<endl;//napraviti ogranicenja za ostale unose
    string prezime;
    cin>>prezime;
